-- Apply Storage RLS Policies for Knowledge Base Buckets
-- This migration ensures the storage policies are properly set up
...
-- ============================================================================
-- UPDATE BUCKET FILE SIZE LIMITS TO 50MB
-- ============================================================================
